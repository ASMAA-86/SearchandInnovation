...
(function($) { // Hide scope, no $ conflict
 ...
 $(selector).datepick('setDate', [date1, date2, date3]) */
		...
		_generateContent: function(elem, inst) {
			...
			var monthRows = '';
			//nabih
			inst.options.renderer.monthRow = '<span class="btn_hijriCal"><input type="button" value="هجرى" id="Cal_btnH"></span><span class="btn_gregCal"><input class="activeMe" type="button" value="ميلادى" id="Cal_btnG"></span><div class="calendars-month-row">{months}</div>';
			...
			//nabih
			$('[id*="btnH"]').click(function () {
				//$('[id*="hdnCalenderType"]').val('islamic');
				if (typeof intializecalender == 'function') {
					intializecalender(1);
				}

			});
			$('[id*="btnG"]').click(function () {
				//$('[id*="hdnCalenderType"]').val('');
				if (typeof intializecalender == 'function') {
					intializecalender(0);
				}
			});
